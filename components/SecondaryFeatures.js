...
function Feature({ feature, isActive, className, ...props }) {
  return (
    ...
    >
      ...
      >
        <svg className="h-9 w-9 outline-none" fill="none">
          <feature.icon />
        </svg>
      </div>
      <h3
        className={clsx(
          "mt-6 text-sm font-medium outline-none bolder-0",
...
export default function SecondaryFeatures() {
  return (
    <section dir="ltr" className="pb-14 pt-20 sm:pb-20 sm:pt-32 lg:pb-32">
      <Container>
