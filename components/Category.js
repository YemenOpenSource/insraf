...
export default function Category({ id, name, description, deleteDepartment }) {
  ...
  return (
    ...
    >
      <h5 className="text-2xl font-bolder tracking-tight text-gray-900">
        {name}
      </h5>
      ...
      <button
        ...
        className="inline-flex items-center font-bolder bg-blue-700 selection:bg-blue-50 selection:text-blue-900 px-3 py-2 text-sm font-medium text-center text-white hover:bg-blue-800 mx-4"
      >
        <Filter primaryColor="white" stroke="bold" size="medium" />
      </button>
