...
export default function Hero() {
  return (
    <Container className="pb-16 pt-5 text-center lg:pt-10">
      <h1 className="mx-auto max-w-4xl select-none font-display text-4xl font-medium font-bolder tracking-tight text-slate-900 sm:text-6xl">
        {/* إنصراف{' '} */}
        <span className="relative whitespace-nowrap text-blue-700">
          <svg
            viewBox="0 0 418 42"
            className="absolute left-0 top-2/3 h-[0.58em] w-full fill-blue-700"
          ...
          <span className="relative font-bolder">إنصراف</span>
        </span>{' '}
        برنامج إدارة الطلاب
      </h1>
